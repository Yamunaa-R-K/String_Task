...
public class Runner {
	...
	System.out.println("Length of the string: " + stringTask.getStringLength(inputString));
        ...
        while (true) {
            ...
            System.out.println("8. Check if String Starts with 'ent'");
            System.out.println("9. Check if String Ends with 'le'");
            ...
            System.out.println("14. Concatenate Strings Without Spaces");
		    ...
		    try
		    {
		    	...
		    	String inputStringForCharArray = scanner.next();
		    ...
		    {
		   	System.out.println("Enter the string: ");
		    	String inputStringForPenultimate = scanner.next();
                    	char penultimateChar = stringTask.getPenultimateCharacter(inputStringForPenultimate);
                    	System.out.println("Penultimate Character: " + penultimateChar);
		    }
		    catch(MyException ex)
		    {
			System.out.println(ex.getMessage());
		    ...
		    {
		    System.out.println("Enter the string: ");
		    String characterCountInput = scanner.next();
		    ...
		    try{
		    System.out.println("Enter the string: ");
		    String greatestPositionInput = scanner.next();
		    ...
		    try{
		    System.out.println("Enter the string: ");
		    String lastCharactersInput = scanner.next();
		    ...
		    try{
		    System.out.println("Enter the string: ");
		    String firstCharactersInput = scanner.next();
		    System.out.println("Enter number of characters: ");
		    int numberOfChars = scanner.nextInt();
		    ...
		    try{
		    System.out.println("Enter the string: ");
		    String replaceCharactersInput = scanner.next();
		    System.out.println("Enter the string to replace: ");
		    String stringToReplace = scanner.next();
		    ...
		    try{
		    System.out.println("Enter the string: ");
		    String startsWithInput = scanner.next();
		    System.out.println("Enter the string: ");
		    String stringStartsWith = scanner.next();
		    ...
		    break;
	            ...
	            try{
		    System.out.println("Enter the string: ");
		    String endsWithInput = scanner.next();
		    System.out.println("Enter the string: ");
		    String stringEndsWith = scanner.next();
		    ...
		    try{
                    ...
                    String lowerCaseString = scanner.next();
		    ...
		    try{
                    ...
                    String upperCaseString = scanner.next();
		    ...
		    try{
                    ...
                    System.out.println("Concatenated string without spaces: " + stringTask.concatenateStrings(line));
		    }
		    catch(MyException ex)
		    {
			System.out.println(ex.getMessage());
		    ...
		    try{
                    ...
                    String[] words = stringTask.encloseInArray(arrayInput);
			...
			System.out.println(ex.getMessage());
                ...
                case 18:
	            try{
                    System.out.print("Enter String 1 for case-insensitive check: ");
                    String caseInsensitiveStr1 = scanner.nextLine();
                    System.out.print("Enter String 2 for case-insensitive check: ");
